// =================================================================
// Advanced Analytics Bot - v139.2 (Full Code & Bug Fix)
// =================================================================
// --- IMPORTS ---
...
async function startBot() {
    try {
        ...
        await bot.api.sendMessage(AUTHORIZED_USER_ID, "✅ *تم إعادة تشغيل البوت بنجاح (نسخة v3 - كاملة)*\n\nتم إصلاح الأخطاء وإضافة جميع الدوال المفقودة.", { parse_mode: "Markdown" }).catch(console.error);
