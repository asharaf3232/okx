// =================================================================
// Advanced Analytics Bot - v143.11 (Final Comprehensive Markdown Fix)
// =================================================================
// --- IMPORTS ---
...
async function startBot() {
    ...
    try {
        ...
        await runDailyJobs();
        connectToOKXSocket();
        await bot.api.sendMessage(AUTHORIZED_USER_ID, "✅ *تم إعادة تشغيل البوت بنجاح \\(v143\\.11 \\- Final Comprehensive Markdown Fix\\)*\n\n\\- تم تطبيق إصلاح شامل ودائم لمشكلة تنسيق الرسائل\\.", { parse_mode: "MarkdownV2" }).catch(console.error);
    } catch (e) {
