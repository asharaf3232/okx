// =================================================================
// Advanced Analytics Bot - v141.1 (Deployment Fix)
// =================================================================
// --- IMPORTS ---
...
startBot();
" in the document above. I want you to make the following changes:
- In the `startBot` function, move the server listening logic for production to the beginning of the function, before the database connection and other startup jobs.
- The rest of the startup logic (connecting to DB, starting jobs, connecting to WebSocket) should run after the server has started listening.
- This will allow the `/healthcheck` endpoint to respond immediately to Railway's request and fix the deployment issue.
- Ensure that the development mode (polling) logic remains in its original place, after the database connecti
