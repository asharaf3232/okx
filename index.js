// =================================================================
// Advanced Analytics Bot - v139.3 (Markdown Parsing Fix)
// =================================================================
// --- IMPORTS ---
...
async function startBot() {
    try {
        ...
        await bot.api.sendMessage(AUTHORIZED_USER_ID, "✅ *تم إعادة تشغيل البوت بنجاح (نسخة v4 - مصححة)*\n\nتم إصلاح خطأ تنسيق الرسائل.", { parse_mode: "Markdown" }).catch(console.error);
